"""LTP stability analysis with continuation method for Floquet multiplier tracking."""
...
def main():
    ...
    # Run analysis
    print("\nRunning LTP continuation analysis (this may take several minutes)...")
    ...
    plt.title("LTP Continuation: Damping vs RPM")
    plt.tight_layout()
    ...
    plt.title("LTP Continuation: Frequency vs RPM")
    plt.tight_layout()
