"""HD stability analysis with continuation method for eigenvalue tracking."""
...
def main():
    ...
    # Run analysis
    print("\nRunning HD continuation analysis...")
    ...
    plt.title(f"HD Continuation: Damping vs RPM (N={problem.number_harmonics})")
    plt.tight_layout()
    ...
    plt.title(f"HD Continuation: Frequency vs RPM (N={problem.number_harmonics})")
    plt.tight_layout()
