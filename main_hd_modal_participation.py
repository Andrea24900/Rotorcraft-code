"""HD Modal Participation Analysis with Interactive Plotting.

This script performs HD continuation analysis and computes modal participation
factors, allowing you to interactively select which state and mode to plot.

Modal Participation Analysis:
-----------------------------
Analyzes how each harmonic component contributes to each mode at each state.
For HD methods, harmonics are extracted directly from the expanded eigenvectors.
...
def main():
    """Run HD modal participation analysis with interactive plotting."""

    print_header("HD Modal Participation Analysis")
    ...
    # Configure for HD with continuation
    rotor.problem.required_solver = "HD"
    rotor.problem.continuation = "YES"
    rotor.problem.number_harmonics = 1  # Using 2 harmonics for detailed analysis
    ...
    # ========================================================================
    # Step 2: Run HD continuation analysis
    # ========================================================================
    print_step(2, 6, "Running HD continuation analysis...")

    cont_analysis = ContinuationAnalysis(rotor)
    cont_analysis = cont_analysis.continuation()

    print(f"  [OK] HD continuation completed")
    ...
    # ========================================================================
    # Step 4: Display overview of all HD modes
    # ========================================================================
    print_step(4, 6, "Displaying overview of all HD modes...")
    ...
    plt.suptitle(f'HD Continuation: Damping of All Modes vs RPM (N={rotor.problem.number_harmonics} harmonics)',
    ...
    # Plot 3: HD Mode Damping
    print("  - Plotting HD mode damping...")
    ...
    plt.suptitle(f'HD Mode Damping: Mode Pair {mode_pair_num}',
                fontsize=14, fontweight='bold')
    plt.tight_layout()
